...
namespace TeamYoshi
{
    public class Mario : IPlayer
    {
        ...
        private MarioLuigiCollision marioLuigiCollision;
        ...
        public void MarioLuigiCollionTest(Luigi luigi)
        {
            marioLuigiCollision.MarioLuigiCollisionTest(this, luigi, sound);
        }
