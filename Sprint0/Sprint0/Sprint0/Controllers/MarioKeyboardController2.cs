...
namespace TeamYoshi
{
    class MarioKeyboardController2 : IController
    {
        ...
        public MarioKeyboardController2()
        {
            ...
            keymap.Add(Keys.N, PossibleCommands.run);
            keymap.Add(Keys.M, PossibleCommands.jump);
