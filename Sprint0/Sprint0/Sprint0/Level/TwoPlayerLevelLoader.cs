...
namespace TeamYoshi
{
    static public class TwoPlayerLevelLoader
    {
        ...
        static public TwoPlayerLevel LoadLevelFromFile(String filename, SoundEffects s)
        {
            TwoPlayerLevel level = null;
        ...
        static private TwoPlayerLevel LoadLevel(StreamReader stream, SoundEffects s)
        {
            ...
            SoundEffects sound = s;
                ...
                while ((tag = stream.ReadLine()) != null && !tag.Equals("</level>"))
                {
                    ...
                    {
                        luigi = new Luigi(xpos.Value, ypos.Value, cam, sound, projectiles);
                    }
                    else
                    {
                        switch (type.Trim('"'))
                ...
                cam.Init(mario);
                return new TwoPlayerLevel(items, enemies, blocks, projectiles, mario, luigi, cam, hud, sound, flagpole);
        }
    }
}
